...
class StableDiffusion3InpaintPipeline(DiffusionPipeline):
    ...
    def __call__(
        ...
        if return_image_latents:
            latents, noise, image_latents = latents_outputs  # noise_latents, image_latents   
        else:
        ...
        mask, masked_image_latents = self.prepare_mask_latents(
            mask_condition,
            masked_image,       # masked image input to vae
            batch_size,
            num_images_per_prompt,
            height,
            width,
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                latents = self.scheduler.step(noise_pred, t, latents, return_dict=False)[0]     # x_t-1
                if num_channels_transformer == 16:
                    ...
                    latents = (1 - init_mask) * init_latents_proper + init_mask * latents       # 将mask和image融入到latents中
