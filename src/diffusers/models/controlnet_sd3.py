...
class SD3ControlNetModel(ModelMixin, ConfigMixin, PeftAdapterMixin, FromOriginalModelMixin):
    ...
    @classmethod
    def from_transformer(cls, transformer, num_layers=12, extra_conditioning_channels=0, load_weights_from_transformer=True):
        config = transformer.config
        config["num_layers"] = num_layers or config.num_layers
        config["extra_conditioning_channels"] = extra_conditioning_channels
        controlnet = cls(**config)
        print("successfully build controlnet.")
